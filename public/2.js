...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('/artigo/' + this.id).then(function (response) {
      if (response.data != null) _this.item = response.data.item;
    });
  },
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "col-sm-8", attrs: { if: "item!=null" } }, [
      _c("div", { staticClass: "card card-post-pag" }, [
        _c("div", { staticClass: "card-body row" }, [
          _c("img", {
            staticClass: "col-4",
            attrs: { src: _vm.item.foto, width: "200", height: "400" }
          }),
          _vm._v(" "),
          _c("div", { staticClass: "col-4 text-right cabecalho" }, [
            _c("h5", { staticClass: "card-title text-left" }, [
              _vm._v(_vm._s(_vm.item.data))
            ]),
            _vm._v(" "),
            _c("h5", { staticClass: "card-title text-left mt-10" }, [
              _vm._v(_vm._s(_vm.item.autor))
            ]),
            _vm._v(" "),
            _c("h2", { staticClass: "card-title text-left titulo" }, [
              _vm._v(_vm._s(_vm.item.titulo))
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "col-9 conteudo" }, [
            _c("p", [_vm._v(_vm._s(_vm.item.conteudo))])
          ])
        ])
      ])
    ])
